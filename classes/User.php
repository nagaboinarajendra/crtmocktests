...
class User{
    ...
    public function userRegistration($name,$username,$password,$email){
        ...
        if($name==""||$username=""||$password==""||$email==""){
            echo "<span class='error'>Fields must be filled</span>";
            exit();
            ...
            exit();
                ...
                if($inserted_row){
                    echo "<span class='success'>Registration success!</span>";
                    exit();
                }else{
                    echo "<span class='error'>Error in data not registered!!</span>";
                    exit();
                }
            }
        }
    ...
    public function enableUser($userid){
        $query = "UPDATE tbl_user SET status='0'
        WHERE userid='$userid'"; 
        $updated_row=$this->db->update($query);
        if($updated_row){
